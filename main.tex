...
% Wrong gateway usage?
% Instantaneous: The model checks in 50ms or less.
% Understandable: Show the visualization of a counterexample using that model.
% Actionable: Show the result of a quick fix when applied to that model and say it is sound now!
