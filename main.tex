...
Thus, our tool can check soundness instantaneously according to the definition (runtime below 500 ms) even if the model size increases to over 4000 BPMN elements (500 blocks).
