...
In addition, one can control the animation speed using the bottom buttons next to the speedometer.
...
Pausing the visualization, controlling the animation speed, and the execution log makes understanding the problem leading to the property violation straightforward.
