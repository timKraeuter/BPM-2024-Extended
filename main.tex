...
\lstinputlisting[language=Rust, style=boxed, caption={Rust code to find all unsafe sequence flows in a state}, label={lst:rust}]{listings/properties-snippet.rs}
