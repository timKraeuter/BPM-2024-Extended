...
% Solution
In this paper, we describe our new tool, which checks BPMN models for soundness and safeness~\cite{corradiniClassificationBPMNCollaborations2018}, which entails finding deadlocks, lack of synchronization, and dead activities.
