...
\begin{table}
	...
	\begin{tblr}{
		...
		e001~\cite{houhouFirstOrderLogicVerification2022} & 10 ms & 31 & Option To Complete, No Dead Activities \\
		e002~\cite{houhouFirstOrderLogicVerification2022} & 10 ms & 31 & Option To Complete, No Dead Activities \\
		e020~\cite{houhouFirstOrderLogicVerification2022} & TBD ms & TBD & TBD \\   % Should be Option To Complete. State space was between 3k-3.5k
		credit-scoring-async\footref{footnote:camundaResearch} & TBD ms & TBD & TBD \\  % Should be Option To Complete
		credit-scoring-sync\footref{footnote:camundaResearch} & 10 ms & 99 & Option To Complete \\
		dispatch-of-goods\footref{footnote:camundaResearch} & 10 ms & 103 & Safeness, Proper Completion\\ 
		recourse\footref{footnote:camundaResearch} & TBD ms & TBD & TBD \\ % Should be Option To Complete
		self-service-restaurant\footref{footnote:camundaResearch} & TBD ms & TBD & TBD \\  % Couldnt run in my other analyzer.
	\end{tblr}
\end{table}
