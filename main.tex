...
We demonstrate that our tool's soundness checking is instantaneous, i.e., takes less than 500ms, by benchmarking our tool against synthetic BPMN models with increasing size and state space complexity, as well as realistic models provided in the literature.
...
Furthermore, we benefit from Rust's memory-safety and thread-safety guarantees.
