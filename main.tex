...
However, the tool is still a \textit{prototype} and cannot provide fixes for all possible violations due to the wide variety of possible BPMN models.
...
A fast programming language and direct implementation of the BPMN semantics play the key role for achieving \textit{instantaneous} soundness checking.
