...
Third, we run soundness checking for realistic BPMN process models available in public datasets, see \autoref{subsec:industrial-models}.
...
% Use the models in corradiniFormalApproachAnalysis2021 --> cannot redistribute.
...
Three realistic models (001, 002, 020) from \cite{houhouFirstOrderLogicVerification2022}.
Maybe 7 additional models from camunda?.

% Check that we can analyze models from the model repositories cited anywhere.
% Especially look for models to be industrial/realistic! --> Some in my previous publications were.
