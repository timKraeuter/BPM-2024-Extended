...
We made sure that an undo operation will revert the whole quick fix at once using the command pattern \cite{gammaDesignPatternsElements1995}.

\begin{figure}[ht]
	\centering
	\includegraphics[width=0.7\textwidth]{images/properCompletion}
	\caption{Quick fix for \textit{Proper Completion}}
