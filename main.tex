...
% TODO: Final submission: Add authors, change artifact link (Zenodo), publish all source code, mention CLI tools for generation(include them and link to the repo), add docker container to the artifacts (tool-with-ui).
% \author{
...
\autoref{fig:overview} shows an overview of our tool, which we provide online~\cite{noauthorgivenBPM2024Artifacts2024}.
